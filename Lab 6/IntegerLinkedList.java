...
// 	private void doubleOddHelper(IntegerNode n) {
// 		if (n == null) {
// 			return;
// 		}
// 		else {
...
// 	private boolean allNegative(IntegerNode n) {
// 		if (n == null) {
// 			return true;
// 		}
// 		else {
// 			if (n.getData() < 0 && allNegative(n.next) == true) {
// 				return true;
// 			}
// 			else {
// 				return false;
...
// 	private boolean isSortedAscending(IntegerNode n) {
// 		if (n == null || n.next == null) {
// 			return true;
// 		}
// 		else {
// 			if (n.getData() <= n.next.getData() && isSortedAscending(n.next) == true) {
// 				return true;
// 			}
// 			else {
// 				return false;
