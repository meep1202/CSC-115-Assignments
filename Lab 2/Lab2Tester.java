...
public class Lab2Tester {
	...
	public static void testIsGradeAbove() {
		...
		result = Lab2.isGradeAbove(s1a, 0);
		displayResults(result == true, "testIsGradeAbove");
	}
	...
	public static void testCountAbove() {
		...
		int result = Lab2.countAbove(students, 51);
	...
	public static void testRegisterStudent() {
		...
		Student s0  = new Student("abc", 50);
		Student s1 = new Student("def", 56);
		Student s2 = new Student("xyz", 69);
		Student s3  = new Student("ppp", 99);
		Student[] studentis = {s0, s1, s2};
		Student[] studentos = {s0, s1, s2, s3};
		Student[] array = Lab2.registerStudent(studentis, s3);
		boolean result = true;
		for (int i = 0; i < array.length && result; i++) {
			result = studentos[i].equals(array[i]);
		}
		displayResults(result, "testRegisterStudent");
	}
